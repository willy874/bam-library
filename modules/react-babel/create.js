...
/**
 * @typedef ReactBabelCreateOptions
 * @property {boolean} [useESModules]
 * @property {boolean} [flow]
 * @property {boolean} [typescript]
 * @property {boolean} [helpers]
 * @property {boolean} [absoluteRuntime]
 * @property {'classic' | 'automatic'} [runtime]
 */
/**
 * @param {*} _
 * @param {ReactBabelCreateOptions} opts
